...
namespace Framework.MVVM
{
    ...
    /// </summary>
    // FIXME by fred
    // [SoftRestartClass(SoftRestartAction.ResetToDefault)] //游戏SoftRestart时，此类型的静态实例会被重置为null
    public abstract class MvvmNode : ViewObject, INode, ICompositeDisposable
    {
        #region 生命周期清理
        ...
        /// </summary>
        public virtual CompositeDisposable DefaultDisposables => DisableDisposables;
        ...
        /// <summary>
        /// 清理自动R3绑定的资源，用于列表等init绑定数据需要清理的情况
        /// </summary>
        protected void ClearAutoR3()
        {
            try
            {
