//**************************************************************************************
//Create By wensx on 2020/05/12.
//
//@Description 复制的StandaloneInputModule源码，增加了对属性的封装，以及修改了以一些方法的访问等级
//**************************************************************************************
...
namespace UnityEngine.EventSystems
{
    ...
    /// </remarks>
    public class StandaloneBaseInputModule : PointerInputModule
    {
        ...
        // 已修改：增加属性封装，一是便于子类访问，二是保持命名规范
        protected PointerEventData InputPointerEvent
        {
            get => m_InputPointerEvent;
            set => m_InputPointerEvent = value;
        }

        // 已修改：增加属性封装，一是便于子类访问，二是保持命名规范
        protected GameObject CurrentFocusedGameObject
        {
            get => m_CurrentFocusedGameObject;
            set => m_CurrentFocusedGameObject = value;
        }

        protected StandaloneBaseInputModule()
        {
        }
        ...
        /// 已修改：覆盖了原方法，以便子类能进行重写
        protected new virtual PointerEventData GetTouchPointerEventData(Touch input, out bool pressed, out bool released)
        {
            return base.GetTouchPointerEventData(input, out pressed, out released);
        }
